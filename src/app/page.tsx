  ...
  return (
    <main>
      <div className='flex flex-col bg-white h-screen'>
        <div className='px-24 py-4 bg-dark text-white flex justify-between'>
        ...
        <div className='flex flex-col gap-4 px-24 py-32 text-white object-fill' style={{ background: "url(/parket.jpg)" }}>
          <div className='text-4xl font-bold'>Работаем с 2000 года</div>
          <div className='text-7xl font-black'>Паркет по Москве и области</div>
        ...
        <div className='flex flex-col'>
          <div className='flex gap-4 items-center justify-between px-72 py-6'>
          ...
          <div className='flex flex-col gap-4 bg-yellow-50 px-72 py-6'>
          ...
          <div className='flex flex-col gap-10 bg-stone-950 text-white px-72 py-6'>
          ...
          <div className='grid grid-cols-4 text-white px-72 py-6'>
            <div className='aspect-square p-4 flex items-end text-3xl font-semibold bg-stone-100 relative overflow-hidden cursor-pointer'>
              <img src='/parketgrid/1.jpeg' className='absolute z-[0] top-0 left-0 hover:scale-125 ease-in duration-300' />
              <div className='z-[1]'>Паркетная доска</div>
            </div>
            <div className='aspect-square p-4 flex items-end text-3xl font-semibold bg-stone-100 relative overflow-hidden cursor-pointer'>
              <img src='/parketgrid/2.jpeg' className='absolute z-[0] top-0 left-0 hover:scale-125 ease-in duration-300' />
              <div className='z-[1]'>Инженерная доска</div>
            </div>
            <div className='aspect-square p-4 flex items-end text-3xl font-semibold bg-stone-100 relative overflow-hidden cursor-pointer'>
              <img src='/parketgrid/3.jpg' className='absolute z-[0] top-0 left-0 hover:scale-125 ease-in duration-300' />
              <div className='z-[1]'>Паркет ёлочка</div>
            </div>
            <div className='aspect-square p-4 flex items-end text-3xl font-semibold bg-stone-100 relative overflow-hidden cursor-pointer'>
              <img src='/parketgrid/4.jpg' className='absolute z-[0] top-0 left-0 hover:scale-125 ease-in duration-300' />
              <div className='z-[1]'>Массивная доска</div>
            </div>
            <div className='aspect-square p-4 flex items-end text-3xl font-semibold bg-stone-100 relative overflow-hidden cursor-pointer'>
              <img src='/parketgrid/5.jpeg' className='absolute z-[0] top-0 left-0 hover:scale-125 ease-in duration-300' />
              <div className='z-[1]'>Деревянные стеновые панели</div>
            </div>
            <div className='aspect-square p-4 flex items-end text-3xl font-semibold bg-stone-100 relative overflow-hidden cursor-pointer'>
              <img src='/parketgrid/6.jpg' className='absolute z-[0] top-0 left-0 hover:scale-125 ease-in duration-300' />
              <div className='z-[1]'>Модульный паркет</div>
            </div>
            <div className='aspect-square p-4 flex items-end text-3xl font-semibold bg-stone-100 relative overflow-hidden cursor-pointer'>
              <img src='/parketgrid/7.jpg' className='absolute z-[0] top-0 left-0 hover:scale-125 ease-in duration-300' />
              <div className='z-[1]'>Ламинат</div>
            </div>
            <div className='aspect-square p-4 flex items-end text-3xl font-semibold bg-stone-100 relative overflow-hidden cursor-pointer'>
              <img src='/parketgrid/8.jpg' className='absolute z-[0] top-0 left-0 hover:scale-125 ease-in duration-300' />
              <div className='z-[1]'>Виниловый пол</div>
            </div>
            <div className='aspect-square p-4 flex items-end text-3xl font-semibold bg-stone-100 relative overflow-hidden cursor-pointer'>
              <img src='/parketgrid/9.jpg' className='absolute z-[0] top-0 left-0 hover:scale-125 ease-in duration-300' />
              <div className='z-[1]'>Террасная доска</div>
            </div>
            <div className='aspect-square p-4 flex items-end text-3xl font-semibold bg-stone-100 relative overflow-hidden cursor-pointer'>
              <img src='/parketgrid/10.jpg' className='absolute z-[0] top-0 left-0 hover:scale-125 ease-in duration-300' />
              <div className='z-[1]'>Геометрический паркет</div>
            </div>
            <div className='aspect-square p-4 flex items-end text-3xl font-semibold bg-stone-100 relative overflow-hidden cursor-pointer'>
              <img src='/parketgrid/11.jpg' className='absolute z-[0] top-0 left-0 hover:scale-125 ease-in duration-300' />
              <div className='z-[1]'>Штучный паркет</div>
            </div>
            <div className='aspect-square p-4 flex items-end text-3xl font-semibold bg-stone-100 relative overflow-hidden cursor-pointer'>
              <img src='/parketgrid/12.png' className='absolute z-[0] top-0 left-0 hover:scale-125 ease-in duration-300' />
              <div className='z-[1]'>Сопутствующие товары</div>
            </div>
          </div>
          <div className='flex flex-col gap-4 px-72 py-6 bg-stone-950 text-white'>
            <div className='text-4xl font-bold'>Закажите достойное напольное покрытие</div>
            <div className='text-2xl font-medium'>Подборка паркета для вашего интерьера</div>
            <div className='flex items-end gap-4'>
              <div className='text-4xl font-bold'>+7 (800) 555-35-35</div>
              <div>Пн-Пт 10:00 - 20:00</div>
              <div>Сб-Вс 11:00 - 19:00</div>
            </div>
          </div>
          <div className='flex flex-col gap-8 px-72 py-6 bg-stone-900 text-white mt-4'>
